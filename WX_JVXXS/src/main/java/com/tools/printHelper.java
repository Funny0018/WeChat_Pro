...
public class printHelper {
    ...
    public static String userBind(String uuid, String userId, String deviceName) {
        String url = printUnit.getUrl("/home/userbind");
        ...
        String result = "";
        try {
            result = printUnit.sendPost(url, data);
        } catch (IOException e) {
    ...
    public static String getDeviceState(String uuid) {
        String url = printUnit.getUrl("/home/getdevicestate");
        JSONObject obj = new JSONObject();
        obj.put("Uuid", uuid);
        String data = obj.toString();
        String result = "";
    ...
    public static String printContent(String uuid, String content, String openUserId) {
        String url = printUnit.getUrl("/home/printcontent2");
        JSONObject obj = new JSONObject();
        obj.put("Uuid", uuid);
    ...
    public static String printHtmlContent(String uuid, String printUrl, String openUserId) {
        String url = printUnit.getUrl("/home/printhtmlcontent");
        JSONObject obj = new JSONObject();
        obj.put("Uuid", uuid);
    ...
    public static String getPrintTaskState(long taskId) {
        String url = printUnit.getUrl("/home/getprinttaskstate");
        JSONObject obj = new JSONObject();
